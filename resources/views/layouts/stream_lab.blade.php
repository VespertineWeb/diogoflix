                                    ...
                                    <div class="gen-carousel-movies-style-2 movie-grid style-2">
                                        <div class="gen-movie-contain">
                                            <div class="gen-movie-img">
                                                <img src="{{ $playlists[$i]->thumbnail }}" alt="owl-carousel-video-image">
                                                <div class="gen-movie-add">
                                                    ...
                                                    <div class="movie-actions--link_add-to-playlist dropdown">
                                                        <a class="dropdown-toggle" href="{{ url('playlist/'.$playlists[$i]->id) }}" data-toggle="dropdown"><i class="fa fa-plus"></i></a>
                                                ...
                                                <div class="gen-movie-action">
                                                    <a href="{{ url('playlist/'.$playlists[$i]->id) }}" class="gen-button">
                                            ...
                                            <div class="gen-info-contain">
                                                <div class="gen-movie-info">
                                                    <h3>
                                                        <a href="{{ url('playlist/'.$playlists[$i]->id) }}">
                                                            {{ $playlists[$i]->title }}
                                                        </a>
                                                    </h3>
                                                </div>
                                                <div class="gen-movie-meta-holder">
                                                    <ul>
                                                        <li> {{ $playlists[$i]->videos_youtube_id->count() }} Vídeos</li>
                                                        <li>
                                                            <a href="{{ url('playlist/'.$playlists[$i]->id) }}"><span>Action</span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                ...
                <div class="col-12">
                    <div class="gen-style-2">
                        <div class="owl-carousel owl-loaded owl-drag" data-dots="false" data-nav="true" data-desk_num="4" data-lap_num="3" data-tab_num="2" data-mob_num="1" data-mob_sm="1" data-autoplay="false" data-loop="false" data-margin="30">
                            ...
                            @for($i =12; $i < 18; $i++) <div class="item">
                                <div class="movie type-movie status-publish has-post-thumbnail hentry movie_genre-action movie_genre-adventure movie_genre-drama">
                                    <div class="gen-carousel-movies-style-2 movie-grid style-2">
                                        <div class="gen-movie-contain">
                                            <div class="gen-movie-img">
                ...
                <div class="col-12">
                    <div class="gen-style-2">
                        <div class="owl-carousel owl-loaded owl-drag" data-dots="false" data-nav="true" data-desk_num="4" data-lap_num="3" data-tab_num="2" data-mob_num="1" data-mob_sm="1" data-autoplay="false" data-loop="false" data-margin="30">
                            ...
                            @for($i =18; $i < 24; $i++) <div class="item">
                                <div class="movie type-movie status-publish has-post-thumbnail hentry movie_genre-action movie_genre-adventure movie_genre-drama">
                                    <div class="gen-carousel-movies-style-2 movie-grid style-2">
                                        <div class="gen-movie-contain">
                                            <div class="gen-movie-img">
                ...
                <div class="col-12">
                    <div class="gen-style-2">
                        <div class="owl-carousel owl-loaded owl-drag" data-dots="false" data-nav="true" data-desk_num="4" data-lap_num="3" data-tab_num="2" data-mob_num="1" data-mob_sm="1" data-autoplay="false" data-loop="false" data-margin="30">
                            ...
                            @for($i =24; $i < 30; $i++) <div class="item">
                                <div class="movie type-movie status-publish has-post-thumbnail hentry movie_genre-action movie_genre-adventure movie_genre-drama">
                                    <div class="gen-carousel-movies-style-2 movie-grid style-2">
                                        <div class="gen-movie-contain">
                                            <div class="gen-movie-img">
