...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('assets') }}/streamlab/images/favicon.ico">
    <!-- CSS bootstrap-->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="gen-single-movie-info">
                                    <h2 class="gen-title">{{ $playlist->title }}</h2>
                            ...
                            <div class="col-lg-12">
                                <div class="pm-inner">
                                    <div class="gen-more-like">
                                        <h5 class="gen-more-title">Vídeos</h5>
                                        <div class="row">

                                            @foreach($playlist->videos_youtube_id as $video)

                                            <div class="col-xl-3 col-lg-4 col-md-6">
                                                <div class="gen-carousel-movies-style-3 movie-grid style-3">
                                                    <div class="gen-movie-contain">
                                                        <div class="gen-movie-img">
                                                            <img src="{{ $video->thumbnail }}" style="width: 100%;" alt="streamlab-image">
